...
<body>
	<div class="container mt-5">
		<form:form action="/Smartphone/product/store"  method="post" modelAttribute="Product" enctype="multipart/form-data">
			<div class="mb-3 row">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-8">
					<form:input type="number" class="form-control" id="inputDate"  path="price"/>
				</div>
			</div>
			<div class="mb-3 row">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-8">
					<form:input type="text" class="form-control" id="inputquantity"  path="quantity"/>
				</div>
			</div>
			<div class="mb-3 row">
				<label for="inputScreen" class="col-sm-2 col-form-label">screen</label>
				<div class="col-sm-8">
					<form:input type="text" class="form-control" id="inputScreen"  path="screen"/>
				</div>
			</div>
			<div class="mb-3 row">
				<label for="inputchip" class="col-sm-2 col-form-label">chip</label>
				<div class="col-sm-8">
					<form:input type="text" class="form-control" id="inputchip"  path="chip"/>
				</div>
			</div>
			<div class="mb-3 row">
				<label for="inputScreen" class="col-sm-2 col-form-label">Create Date</label>
				<div class="col-sm-8">
					<form:input type="date" class="form-control" id="inputScreen"  path="createDate"/>
				</div>
			</div>
			<div class="mb-3 row">
